                    ...
                    return (
                        <SwiperSlide className="container" key={i}>
                          <Card
                            ...
                            <div>
                              <Avatar src={item?.applicant?.image&&<Image width="100%" height="50px" src={item?.applicant?.image}> </Image>} className="m-0 p-0" style={{backgroundColor:item?.applicant?.fullName&&stringToHslColor(item?.applicant?.fullName,50,50),float:'left'}} size={45}>{
                                  item?.applicant?.fullName[0].toUpperCase()}</Avatar>
                              <span className="d-flex p-2 justify-content-center aligin-items-center" style={{backgroundColor:"",float:'left'}} >{item?.applicant?.fullName}</span>
                            </div>
                          } className="shadow m-2">
