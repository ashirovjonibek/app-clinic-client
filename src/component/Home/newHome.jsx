                ...
                <div style={{lineHeight:"28px"}} className="row">
                  <div className="col-12 col-md-12 left-block">
                    <div className="details">
                      <h3 style={{fontSize:"20px",fontWeight:600}}>{t("Ensuring that trainees undergo internships at the clinic during their studies at the Academy")}:</h3>
                  ...
                  <div className="col-12 col-md-12 left-block">
                    <div className="details">
                      <h3 style={{fontSize:"20px",fontWeight:600}}>{t("Regarding the provision of free legal aid to individuals and legal entities")}:</h3>
                      <p style={{paddingLeft:"20px"}}>
                        <ul >
                          <li style={{listStyleType:'circle',fontSize:"17px"}}>
                  ...
                  <div className="col-12 col-md-12 left-block">
                    <div className="details">
                      <h3 style={{fontSize:"20px",fontWeight:600}}>{t("To increase the level of professional training of students and develop their skills in working with legal entities and individuals")}:</h3>
                      <p style={{paddingLeft:"20px"}}>
                        <ul >
                          <li style={{listStyleType:'circle',fontSize:"17px"}}>
