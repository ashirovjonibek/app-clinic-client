        ...
        <div style={props.style}>
            {
                props?.size ? <div className="size-page">
                    <span className="span-item page_size_text"
                          style={{fontSize: "20px"}}> {props.t("Page size")}: </span>
                                ...
                                pages && pages?.map((item) =>
                                    <span key={item.page} onClick={() => {
                                        props.setActive(item.page)
                                          ...
                                          className={item.classPage}>{item.page}</span>
                                )
                            }
                        </> :
                        <>
                            {
                                (props?.active - 1) > 1 ? <span className="span-item tree-dots" style={{
                                    fontSize: "20px",
                                    padding: "8px 0",
                                    margin: 0
                                }}>...</span> : ""
                                ...
                                pages && pages?.map((item) =>
                                    <span key={item.page} onClick={() => {
                                        props.setActive(item.page)
                                          ...
                                          className={"span-item " + item.classPage}>{item.page}</span>
                                )
                            }
                            {
                                (props?.active + 1) < props?.pageLength ? <span className="span-item tree-dots" style={{
                                    fontSize: "20px",
                                    padding: "8px 0",
                                    margin: 0
                                }}>...</span> : ""
