        ...
        <Row className="border mt-2 rounded" gutter={24}>
            ...
            <Col className="pb-1" xs={12} sm={12} md={12} lg={12}>
                <Avatar className="m-0 p-0"
                    src={item?.image&&<Image src={item?.image} style={{ width: "100%", height: "45px", objectFit: 'cover' }} />}
                    ...
                    <Col className="p-3" xs={24} sm={24} md={24} lg={24}>
                        ...
                        <Row>
                            {answer?.attachmentId&&<Col lg={3} md={4} sm={8} xs={12} className="p-1">
                                <Tag onClick={() => { setDoc(API_URL + '/attach/' + answer?.attachmentId[0]); setDocOpen(true) }} style={{ width: "100%", cursor: 'pointer' }} className="text-center p-2 rounded">
