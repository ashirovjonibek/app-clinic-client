                ...
                <div className="statistic-item">
                    ...
                    <div className="statistic-item-progres-section">
                        <div className="item-progres">
                            <div className="progres-vov" style={{width: '50px'}}/>
                            <div className="progres-afgan" style={{width: '200px'}}/>
                            <div className="progres-mom" style={{width: '150px'}}/>
                            <div className="progres-1grup" style={{width: '400px'}}/>
                            <div className="progres-2grup" style={{width: '250px'}}/>
                            <div className="progres-3grup" style={{width: '100px'}}/>
                        </div>
                    </div>
                </div>
                <div className="statistic-item">
                ...
                <div className="categories-inform">
                    <div className="categories">
                        <div className="categories-item">
                            ...
                            <p>Льготы у заявителей<br /> участник ВОВ</p>
                        </div>
                        <div className="categories-item">
                            <input type="checkbox" className="checkbox" />
                            <div className="categories-color" style={{backgroundColor: '#F57670'}}/>
                            <p>Льготы у заявителей<br /> участник войны в Афганистане</p>
                        </div>
                        <div className="categories-item">
                            <input type="checkbox" className="checkbox" />
                            <div className="categories-color" style={{backgroundColor: '#DAF285'}}/>
                            <p>Льготы у заявителей<br /> мать одиночка</p>
                        </div>
                    </div>
                    <div className="categories" style={{ paddingLeft: '60px' }}>
                        <div className="categories-item">
                            <input type="checkbox" className="checkbox" />
                            <div className="categories-color" style={{backgroundColor: '#B393E0'}}/>
                            <p>Льготы у заявителей<br /> инвалидность 1 группы</p>
                        </div>
                        <div className="categories-item">
                            <input type="checkbox" className="checkbox" />
                            <div className="categories-color" style={{backgroundColor: '#5DDAF0'}}/>
                            <p>Льготы у заявителей<br /> инвалидность 2 группы</p>
                        </div>
                        <div className="categories-item">
                            <input type="checkbox" className="checkbox" />
                            <div className="categories-color" style={{backgroundColor: '#FFDB67'}}/>
                            <p>Льготы у заявителей<br /> инвалидность 3 группы</p>
                        </div>
                    </div>
                </div>
            </div>
