        ...
        <div className="statistic-gender">
            ...
            <div className="statistic-section-item-body">
                ...
                <div className="statistic-item">
                    ...
                    <div className="statistic-item-progres-section">
                        <div className="item-progres">
                            <div className="progres-women" style={{width: '390px'}}/>
                            <span className="item">123</span>
                        </div>
                        <div className="item-progres">
                            <div className="progres-men" style={{width: '270px'}}/>
                            <span className="item">123</span>
                        </div>
                    </div>
                </div>
                <div className="statistic-item">
                    ...
                    <div className="statistic-item-progres-section">
                        <div className="item-progres">
                            <div className="progres-women" style={{width: '190px'}}/>
                            <span className="item">123</span>
                        </div>
                        <div className="item-progres">
                            <div className="progres-men" style={{width: '70px'}}/>
                            <span className="item">123</span>
                        </div>
                    </div>
                </div>
                <div className="statistic-item">
                    ...
                    <div className="statistic-item-progres-section">
                        <div className="item-progres">
                            <div className="progres-women" style={{width: '490px'}}/>
                            <span className="item">123</span>
                        </div>
                        <div className="item-progres">
                            <div className="progres-men" style={{width: '370px'}}/>
                            <span className="item">123</span>
                        </div>
                    </div>
                </div>
                <div className="statistic-item">
                    ...
                    <div className="statistic-item-progres-section">
                        <div className="item-progres">
                            <div className="progres-women" style={{width: '290px'}}/>
                            <span className="item">123</span>
                        </div>
                        <div className="item-progres">
                            <div className="progres-men" style={{width: '170px'}}/>
                            <span className="item">123</span>
                        </div>
                    </div>
                </div>
                <div className="statistic-item">
                    ...
                    <div className="statistic-item-progres-section">
                        <div className="item-progres">
                            <div className="progres-women" style={{width: '90px'}}/>
                            <span className="item">123</span>
                        </div>
                        <div className="item-progres">
                            <div className="progres-men" style={{width: '270px'}}/>
                ...
                <div className="statistic-item">
                    ...
                    <div className="statistic-item-progres-section">
                        <div className="item-progres">
                            <div className="progres-women" style={{width: '150px'}}/>
                            <span className="item">123</span>
                        </div>
                        <div className="item-progres">
                            <div className="progres-men" style={{width: '370px'}}/>
                ...
                <div className="statistic-item">
                    ...
                    <div className="statistic-item-progres-section">
                        <div className="item-progres">
                            <div className="progres-women" style={{width: '120px'}}/>
                            <span className="item">123</span>
                        </div>
                        <div className="item-progres">
                            <div className="progres-men" style={{width: '190px'}}/>
                            <span className="item">123</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="statistic-item">
                    ...
                    <div className="statistic-item-progres-section">
                        <div className="item-progres">
                            <div className="progres-women" style={{width: '110px'}}/>
                            <span className="item">123</span>
                        </div>
                        <div className="item-progres">
                            <div className="progres-men" style={{width: '220px'}}/>
                            <span className="item">123</span>
                        </div>
                    </div>
                </div>
                <div className="statistic-item">
                    ...
                    <div className="statistic-item-progres-section">
                        ...
                        <div className="item-progres">
                            <div className="progres-men" style={{width: '470px'}}/>
                            <span className="item">123</span>
                        </div>
                    </div>
                </div>
